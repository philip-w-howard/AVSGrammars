...
\newcommand{\faloopleftt}[2] {\path (#1) edge [loop left] node {#2} ();}
...
%first construct $a^*$, 
%then construct $(b | c)$ and then use the concatenation construction to combine them. Here are the results:
