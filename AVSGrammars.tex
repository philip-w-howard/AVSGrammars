...
\end{cfg}
%----------------------------------------------------------
\item Use the following CFG and show derivations for the two expressions from the previous problems. Be sure to list the production numbers for each step.
%----------------------------------------------------------
\begin{cfg}{}{}
Q\cfgprod{START}{EXPR}Q
Q\cfgprod{EXPR}{FACT+EXPR}Q
Q\cfgprod{EXPR}{FACT}Q
Q\cfgprod{FACT}{(EXPR)}Q
Q\cfgprod{FACT}{FACT * number}Q
