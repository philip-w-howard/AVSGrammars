...
\newcommand{\faloopright}[2] {\draw [arrows={-{Latex[length=3mm,width=2.5mm]}}] (#1) edge [loop right] node {#2} ();}
\newcommand{\faloopleftt}[2] {\path [-{Latex[length=3mm,width=2.5mm]}] (#1) edge [loop left] node {#2} ();}
%\faloopback {4+}{4+}{a,b}{30}{330};
%---------------------------------------------------
